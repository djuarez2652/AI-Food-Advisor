...
then give DIFFERENT meals that have NOT been stated already.
Ensure that the meals will help reach the goal that the user inputs.
Give some options for each meal, at least 2 and at most 3.
Format your response like so -- do NOT include any other filler
words or sentences and list the options with NO numbers,
start with the name:
